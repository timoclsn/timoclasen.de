jQuery(document).ready(function(){
	...
	$('.dropzone').droppable({
	    ...
	    drop: function (event, ui) {
			...
			var $newItems = $('<img class="item element moods ' + begriff + ' ' + kategoriemood + ' ' + gruppemood + '" src="bilder/' + firstClass + '.png" />');
